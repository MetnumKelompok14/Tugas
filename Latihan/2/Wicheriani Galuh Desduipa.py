...
try:
    ...
    plt.axhline(0, color='red', linestyle='--') # Menambahkan garis horizontal pada y dengan warna merah dan garis putus-putus
    plt.axvline(0, color='green', linestyle='--') # Menambahkan garis vertikal pada akar dengan warna hijau dan garis putus-putus
    plt.xlabel('x')
    plt.ylabel('y')
    plt.grid(True)
    plt.legend()
